...
The library is stored as a `library.json` file in the same directory as the executable. Each entry is keyed by the ePub's internal identifier or Title:Author if an identifier is not available.
